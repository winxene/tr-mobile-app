...
class BuyingOptionScreen extends StatefulWidget {
  const BuyingOptionScreen({Key? key}) : super(key: key);
  static const routeName = '/buying_option_screen';

  @override
  State<BuyingOptionScreen> createState() => _BuyingOptionScreenState();
}
...
class _BuyingOptionScreenState extends State<BuyingOptionScreen> {
  int value = 0;
      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            child: Text(
              "A fraganant and delicated brew jasmine tea from our garden",
              style: TextStyle(
                color: Colors.white,
                fontSize: 12,
              ),
